...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->error['custom_h1'])) {
            $data['error_custom_h1'] = $this->error['custom_h1'];
        } else {
            $data['error_custom_h1'] = array();
        }
        ...
        if (isset($this->request->post['custom_h1'])) {
            $data['custom_h1'] = $this->request->post['custom_h1'];
		...
		if (isset($this->request->post['x2_stiker'])) {
			$data['x2_stiker'] = $this->request->post['x2_stiker'];
		} elseif (!empty($product_info)) {
			$data['x2_stiker'] = $product_info['x2_stiker'];
		} else {
			$data['x2_stiker'] = 0;
		}
