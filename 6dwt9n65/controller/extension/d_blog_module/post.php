...
// $url = $this->getUrl();
    ...
    protected function getForm() {
        ...
        $this->document->addScript('../admin/view/javascript/d_bootstrap_tagsinput/bootstrap-tagsinput.js');
        $this->document->addStyle('../admin/view/javascript/d_bootstrap_tagsinput/bootstrap-tagsinput.css');
        ...
        if (isset($this->request->post['post_seo_url'])) {
            ...
            $data['post_seo_url'] = $this->model_extension_d_blog_module_post->getPostSeoUrls($this->request->get['post_id']);
        } else {
