	...
	function field_typelayout($nameconfig,$element,$element_array,$columns= null){
		...
		foreach ($element_array as  $fc){
			...
			if($fc['key'] == $values){
				...
				$fieldType  .= '<span class="type fa active" data-keylayout="'.$keylayout.'" data-keyheader="'.$keyheader.'" data-keyfooter="'.$keyfooter.'" ><img  src="'.DIR_SOCONFIG.'images/desktop/'.$element.$fc['key'].'.jpg" alt="'.$element.$fc['key'].'"/></span>';
			}else{
				$fieldType  .= '<input type="radio" name="'.$names.'" value="'.$fc['key'].'" >';
				$fieldType  .= '<span class="type fa" data-keylayout="'.$keylayout.'" data-keyheader="'.$keyheader.'" data-keyfooter="'.$keyfooter.'"><img src="'.DIR_SOCONFIG.'images/desktop/'.$element.$fc['key'].'.jpg" alt="'.$element.$fc['key'].'"/></span>';
			}
			$fieldType  .= '</label>';
