...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			$lastComment = $this->model_account_order->getLastComment($result['order_id']);
			$data['orders'][] = array(
				'order_id'   => $result['order_id'],
				'order_ref'   =>  'INV' . str_pad($result['order_id'],  6, "0"),
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['order_ref']  =  'INV' . str_pad($this->request->get['order_id'],  6, "0");
