...
class ControllerExtensionQuickCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			if (!$this->cart->hasStock() && (!$this->config->get('config_stock_checkout') || $this->config->get('config_stock_warning'))) {
				$data['error_warning_stock'] = sprintf($this->language->get('error_stock'), $this->url->link('product/product', 'product_id=75'), $this->url->link('product/product', 'product_id=76'), $this->url->link('product/product', 'product_id=66'));
			}
		}
	...
	public function update() {
		...
		if (!$this->cart->hasStock() && (!$this->config->get('config_stock_checkout') || $this->config->get('config_stock_warning'))) {
           	$json['error']['stock'] = sprintf($this->language->get('error_stock'), $this->url->link('product/product', 'product_id=75'), $this->url->link('product/product', 'product_id=76'), $this->url->link('product/product', 'product_id=66'));
        } else {
        	$json['error']['stock'] = '';
        }
