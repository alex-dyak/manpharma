...
class ControllerExtensionQuickCheckoutCheckout extends Controller {
	...
	public function index() {
		...
		$data['text_security_1'] = $this->language->get('text_security_1');
		$data['text_security_2'] = sprintf($this->language->get('text_security_2'),$this->url->link('information/contact'));
