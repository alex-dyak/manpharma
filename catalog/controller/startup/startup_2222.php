...
class ControllerStartupStartup extends Controller {
	public function index() {
		...
		if (!$code) {
			...
			if ( end($uri_segments) != 'index.php') {
				if (!empty($uri_segments)) {
					$urlseo = end($uri_segments);
					$sql="SELECT language_id FROM " . DB_PREFIX . "seo_url WHERE keyword='". $urlseo ."' AND store_id='".(int)$this->config->get('config_store_id')."'";
