...
$_['text_reviews']      = '%s Bewertungen für %s';
$_['text_write']        = '+ Bewertung';
$_['text_login']		= 'Bitte <a href="%s">anmelden</a> oder <a href="%s">registrieren</a> um Bewertung zu verfassen';
$_['text_no_reviews']   = 'Für dieses Produkt gibt es noch keine Bewertungen. Seien Sie der Erste, der Ihre Bewertung hinterlässt.';
...
$_['text_year']					= 'Jahr(e)';
$_['text_per_pill']			    = 'pro Pille';
$_['text_per_bag']			    = 'pro Sachets';
$_['text_package_delivery']   = '+ Versandversicherung';
$_['text_next_purchase']      = '+ <strong>Discount</strong> auf den nächsten Kauf';
$_['text_you_save']           = 'Sie sparen';
$_['text_x2_sale']		= 'erhalte %s pillen als Geschenk!';
$_['text_select_dose']        = 'Dosis auswählen';
$_['text_out_of_stock']		  = 'Leider ist das gesuchte Produkt derzeit nicht verfügbar. Wir haben jedoch gute Nachrichten! Nachfolgend haben wir einige alternative Produkte mit den gleichen Wirkstoffen zu einem noch günstigeren Preis aufgelistet, die Sie stattdessen kaufen können.';
