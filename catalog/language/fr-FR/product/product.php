...
$_['text_reviews'] = '%s évaluation(s) pour %s';
$_['text_write'] = 'Donnez votre avis';
$_['text_login'] = 'Veuillez vous <a href="%s">connecter</a> ou vous <a href="%s">inscrire</a> pour évaluer';
$_['text_no_reviews'] = 'Il n’y a aucune évaluation sur ce produit. Soyez le premier à laisser votre avis.';
$_['text_send_review']  = 'Geben Sie Ihre Bewertung';
...
$_['entry_good'] = 'Bon';
$_['entry_bad'] = 'Mauvais';
$_['text_out_of_stock'] = "Malheureusement, le produit que vous recherchez n'est pas disponible actuellement. Cependant, nous avons de bonnes nouvelles ! Nous avons répertorié ci-dessous quelques produits alternatifs avec les mêmes ingrédients actifs à un prix encore meilleur que vous pouvez acheter à la place.";
$_['text_per_pill'] = 'per pilule';
$_['text_per_bag'] = 'per sachets';
$_['text_x2_sale']		= 'recevez %s comprimés en cadeau';
...
$_['text_package_delivery']   = '+ Assurance livraison de colis';
$_['text_next_purchase']      = '+ <strong>Remise</strong> sur prochain achat';
$_['text_you_save']           = 'Vous économisez';
$_['text_select_dose']        = 'Sélectionnez les doses';