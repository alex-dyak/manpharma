...
class ModelAccountOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'order_ref'               =>  'INV' . str_pad($order_query->row['order_id'],  6, "0"),
	...
	public function getLastComment($order_id){
		$sql = "SELECT * FROM ".DB_PREFIX."order_history WHERE order_id = ".(int)$order_id." ORDER BY date_added DESC LIMIT 1";
