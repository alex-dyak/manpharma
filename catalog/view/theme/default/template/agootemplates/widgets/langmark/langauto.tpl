...
if (/Android|iPhone|iPad|iPod|Windows Phone|webOS|BlackBerry/i.test(lm_<?php echo $settings_widget['cmswidget']; ?>_userAgent)) {
	document.body.addEventListener('touchstart', lm_<?php echo $settings_widget['cmswidget']; ?>_afterload_auto); document.body.addEventListener('touchmove', lm_<?php echo $settings_widget['cmswidget']; ?>_afterload_auto); document.addEventListener('DOMContentLoaded', function() { setTimeout(lm_<?php echo $settings_widget['cmswidget']; ?>_afterload_auto, 9000) });
} else {document.body.addEventListener('mouseover', lm_<?php echo $settings_widget['cmswidget']; ?>_afterload_auto); document.addEventListener('mousemove', lm_<?php echo $settings_widget['cmswidget']; ?>_afterload_auto); document.addEventListener('DOMContentLoaded', function() { setTimeout(lm_<?php echo $settings_widget['cmswidget']; ?>_afterload_auto, 5000); }); }
